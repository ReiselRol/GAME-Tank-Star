...
/*
	shader_set_uniform_f(shader_get_uniform(SketchShader, "uni_Sketch_Resolution"), window_get_width(), window_get_height());
	shader_set_uniform_f(shader_get_uniform(SketchShader,"uni_Sketch_Intensity"), 0.5);
*/