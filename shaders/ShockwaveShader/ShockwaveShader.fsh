...
/*
  ...
  shader_set_uniform_f(shader_get_uniform(ShockwaveShader, "uni_shockwave_time"), 0);
  shader_set_uniform_f(shader_get_uniform(ShockwaveShader, "uni_shockwave_mouse_pos"), x, y);
  shader_set_uniform_f(shader_get_uniform(ShockwaveShader, "uni_shockwave_resolution"), window_get_width(), window_get_height());
  shader_set_uniform_f(shader_get_uniform(ShockwaveShader, "uni_shockwave_amplitude"), 0.5);
  shader_set_uniform_f(shader_get_uniform(ShockwaveShader, "uni_shockwave_refraction"), 0.8;
  shader_set_uniform_f(shader_get_uniform(ShockwaveShader, "uni_shockwave_width"), 0.1);
