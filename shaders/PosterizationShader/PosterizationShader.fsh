...
/*
	shader_set_uniform_f(shader_get_uniform(PosterizationShader, "uni_Posterization_gamma"), 0.6);
	shader_set_uniform_f(shader_get_uniform(PosterizationShader, "uni_Posterization_num_colors"), 8.0);
*/