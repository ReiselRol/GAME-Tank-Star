...
if (Gun_ScopeID > -1) {
	draw_sprite_ext(Gun_ScopeColor, 0, x, y, Gun_Scale, Gun_Scale, image_angle, Gun_SecondaryColor, 1)
	draw_sprite_ext(Gun_ScopeChasis, 0, x, y, Gun_Scale, Gun_Scale, image_angle, c_white, 1)
	if (Gun_SkinCannonPaint != 0) draw_sprite_ext(Gun_ScopePainted, 0, x, y, Gun_Scale, Gun_Scale, image_angle, Tank_GetPaintColor(Gun_SkinCannonPaint), 1)
}
